...
export const historyItem: ToolbarItemUnion = {
  type: ComponentItem.ToolbarGroup,
  label: 'History',
  items: [
    { type: ComponentItem.ToolbarElement, element: <UndoBtn key="undo" /> },
    { type: ComponentItem.ToolbarElement, element: <RedoBtn key="redo" /> },
  ],
  separator: 'end',
};
...
export const clipboardItem: ToolbarItemUnion = {
  type: ComponentItem.ToolbarGroup,
  label: 'Clipboard',
  items: [
    { type: ComponentItem.ToolbarElement, element: <CopyBtn key="copy" /> },
    { type: ComponentItem.ToolbarElement, element: <CutBtn key="cut" /> },
    { type: ComponentItem.ToolbarElement, element: <PasteBtn key="paste" /> },
  ],
  separator: 'end',
};
...
export const headItem: ToolbarItemUnion = {
  type: ComponentItem.ToolbarGroup,
  label: 'head',
  items: [{ type: ComponentItem.ToolbarElement, element: <HeadBtn key="head" /> }],
  separator: 'end',
};
...
export const listItem: ToolbarItemUnion = {
  type: ComponentItem.ToolbarGroup,
  label: 'Lists',
  items: [
    { type: ComponentItem.ToolbarElement, element: <BulletListBtn key="bulletList" /> },
    { type: ComponentItem.ToolbarElement, element: <OrderedListBtn key="orderList" /> },
    { type: ComponentItem.ToolbarElement, element: <TaskListBtn key="testList" /> },
  ],
  separator: 'end',
};
...
export const contentWidgetItem: ToolbarItemUnion = {
  type: ComponentItem.ToolbarElement,
  element: <ContentWidget />,
};
...
export const vcWidgetItem: ToolbarItemUnion = {
  type: ComponentItem.ToolbarElement,
  element: <VcWidget />,
};
...
export const newCommItem = (param: NewCommItemParam): ToolbarItemUnion => {
  return {
    type: ComponentItem.ToolbarGroup,
    ...
    items: [
      ...
      },
      {
        type: ComponentItem.ToolbarElement,
        element: (
          <AddUploadFile fsId={param.fsId} ownerType={param.ownerType} ownerId={param.ownerId} />
        ),
      },
      { type: ComponentItem.ToolbarElement, element: <AddCode /> },
      { type: ComponentItem.ToolbarElement, element: <AddExcaliDraw /> },
      { type: ComponentItem.ToolbarElement, element: <AddFortuneSheet /> },
    ],
    separator: 'end',
  };
};
