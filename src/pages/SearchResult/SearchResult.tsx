import { SEARCH_SCOPE_ALL_CHANNEL, SEARCH_SCOPE_ALL_DOC_SPACE, SEARCH_SCOPE_BUG, SEARCH_SCOPE_CUR_CHANNEL, SEARCH_SCOPE_CUR_DOC_SPACE, SEARCH_SCOPE_TASK } from "@/components/SearchBar";
