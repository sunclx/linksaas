...
import { ADMIN_PATH_ORG_LIST_SUFFIX, ADMIN_PATH_PROJECT_CREATE_SUFFIX, ADMIN_PATH_PROJECT_DETAIL_SUFFIX, ADMIN_PATH_PROJECT_LIST_SUFFIX, ADMIN_PATH_USER_CREATE_SUFFIX, ADMIN_PATH_USER_DETAIL_SUFFIX, ADMIN_PATH_USER_LIST_SUFFIX, USER_LOGIN_PATH } from "@/utils/constant";
...
const AdminNav = () => {
    ...
    return (
        <Layout.Sider>
            ...
            <Collapse defaultActiveKey={["user", "org", "project"]}>
