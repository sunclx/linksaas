...
import { RESOURCE_TYPE_DEPLOYMENT, RESOURCE_TYPE_NAMESPACE, list_resource, list_resource_perm } from '@/api/k8s_proxy';
import type { NamespaceList } from "kubernetes-models/v1";
import type { ResourcePerm } from "@/api/k8s_proxy";
import type { DeploymentList, IIoK8sApiAppsV1Deployment } from "kubernetes-models/apps/v1";
